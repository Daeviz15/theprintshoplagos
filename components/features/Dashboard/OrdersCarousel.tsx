        ...
        >
          {orders.map((order, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-full h-full rounded-[2rem] overflow-hidden border transition-all duration-700 ${
                    isFront
        ...
        {selectedOrder && (() => {
          ...
          return (
            <motion.div
              ...
              className="fixed inset-0 z-[999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 md:p-8"
